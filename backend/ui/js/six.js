...
app.controller('SixthCtrl', ['$scope', '$rootScope', '$http', function($scope, $rootScope, $http){
	...
	$scope.loadScenarioNames = function() {
		...
		$http.get('/scenarios').then(function (response) {
	...
	$scope.fetchReleases = function() {
		...
		$http.get('/releases/' + $scope.selectedScenarioId).then(function (response) {
	...
	$scope.loadTestExects = function() {
		...
		$scope.tests = [];
		$http.get('/testexecdetails/' + $scope.selectedReleaseId).then(function (response) {
	...
	$scope.save = function () {
		...
		$http.post('/testexecdetails/' + $scope.selectedReleaseId, model).then(function (response) {
